...
BXM_HSTDSP "#>>    Process Name  :  DepositCcBatch.sh"
BXM_HSTDSP "########################################"
...
BXM_TRY $APPLICATION_LOCATION $APPLICATION_NAME $BAT_CODE CCID='CZFB00002' $FNAME $SEQNUM
