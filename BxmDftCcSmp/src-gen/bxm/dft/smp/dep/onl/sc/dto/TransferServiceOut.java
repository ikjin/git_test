...
/**
 * @Description 이체서비스 출력
 */
@XmlType(propOrder={"cusNm", "accNum", "amt"}, name="TransferServiceOut")
@XmlRootElement(name="TransferServiceOut")
@SuppressWarnings("all")
public class TransferServiceOut  implements IOmmObject, Predictable, FieldInfo  {

	private static final long serialVersionUID = 1246536966L;

	@XmlTransient
	public static final String OMM_DESCRIPTION = "이체서비스 출력";
	...
	* Property set << accNum >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="계좌번호", formatType="masking", format="ALL", align="left", length=6, decimal=0, arrayReference="", fill="", comment="", encrypt="", validationRule="")
	...
	*******************************************************************************************************************************/
	...
	@Override
	public TransferServiceOut clone(){
		try{
			TransferServiceOut object= (TransferServiceOut)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.dep.onl.sc.dto.TransferServiceOut other= (bxm.dft.smp.dep.onl.sc.dto.TransferServiceOut)obj;
		if ( cusNm == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.dep.onl.sc.dto.TransferServiceOut:\n");
		sb.append("\tcusNm: ");
		sb.append(cusNm==null?"null":getCusNm());
		sb.append("\n");
		sb.append("\taccNum: ");
		sb.append(accNum==null?"null":getAccNum().toString().replaceAll(".","*"));
		sb.append("\n");
		sb.append("\tamt: ");
