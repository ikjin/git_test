 ...
 * @Description 
 */
@XmlType(propOrder={"cusNm", "accNum", "amt"}, name="PaymentServiceOut")
@XmlRootElement(name="PaymentServiceOut")
@SuppressWarnings("all")
public class PaymentServiceOut  implements IOmmObject, Predictable, FieldInfo  {

	private static final long serialVersionUID = 247079005L;
	...
	*******************************************************************************************************************************/
	...
	@Override
	public PaymentServiceOut clone(){
		try{
			PaymentServiceOut object= (PaymentServiceOut)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.dep.onl.sc.dto.PaymentServiceOut other= (bxm.dft.smp.dep.onl.sc.dto.PaymentServiceOut)obj;
		if ( cusNm == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.dep.onl.sc.dto.PaymentServiceOut:\n");
		sb.append("\tcusNm: ");
