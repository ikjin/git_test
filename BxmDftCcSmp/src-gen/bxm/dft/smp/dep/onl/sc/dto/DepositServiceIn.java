 ...
 * @Description 
 */
@XmlType(propOrder={"cusNo", "accNum", "amt"}, name="DepositServiceIn")
@XmlRootElement(name="DepositServiceIn")
@SuppressWarnings("all")
public class DepositServiceIn  implements IOmmObject, Predictable, FieldInfo  {

	private static final long serialVersionUID = 1427014814L;
	...
	* Property set << amt >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="입금금액", formatType="", format="", align="right", length=20, decimal=0, arrayReference="", fill="", comment="", encrypt="", validationRule="")
	...
	*******************************************************************************************************************************/
	...
	@Override
	public DepositServiceIn clone(){
		try{
			DepositServiceIn object= (DepositServiceIn)super.clone();
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.dep.onl.sc.dto.DepositServiceIn other= (bxm.dft.smp.dep.onl.sc.dto.DepositServiceIn)obj;
		if ( cusNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.dep.onl.sc.dto.DepositServiceIn:\n");
		sb.append("\tcusNo: ");
